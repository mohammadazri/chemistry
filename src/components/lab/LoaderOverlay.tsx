        ...
        <Html center className="pointer-events-none select-none">
            <div className="flex flex-col items-center justify-center w-[300px] h-[300px] bg-background/80 backdrop-blur-2xl border border-indigo-500/30 rounded-3xl shadow-[0_0_50px_rgba(79,70,229,0.3)] relative overflow-hidden">
                ...
                <div className="text-center z-10 w-full px-8">
                    <h2 className="text-lg font-bold text-white tracking-wider mb-2">HoloLab OS</h2>
                    <p className="text-xs text-indigo-300 font-medium uppercase tracking-[0.2em] mb-4 h-4 overflow-hidden truncate">
                        {item ? `Loading: ${item.split('/').pop()}` : 'Initializing Environment...'}
                    </p>

                    {/* Progress Bar */}
                    <div className="w-full bg-gray-800/80 rounded-full h-1.5 mb-2 overflow-hidden border border-white/5">
                        <div
